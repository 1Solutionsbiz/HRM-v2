    ...
    <div className="space-y-6">
      ...
      >
        {tickets.length === 0 ? (
          ...
          <Card>
            {/* Below sm, a 5-column table needs horizontal scrolling that
                reads as clipped rather than intentional (same issue fixed
                on the /attendance grid) - a stacked list fits instead. */}
